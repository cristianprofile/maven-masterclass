...
public class BaseIntegrationTest {
    ...
    public void testFindEntries() {
        ...
        List<Base> result = baseRepository.findAll(new org.springframework.data.domain.PageRequest(firstResult / maxResults, maxResults)).getContent();
    ...
    public void testDelete() {
        ...
        baseRepository.flush();
        Assert.assertNull("Failed to remove 'Base' with identifier '" + id + "'", baseRepository.findOne(id));
    }
}

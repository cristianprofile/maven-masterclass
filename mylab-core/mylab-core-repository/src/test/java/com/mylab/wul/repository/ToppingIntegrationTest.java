...
public class ToppingIntegrationTest {
    ...
    public void testFindEntries() {
        ...
        List<Topping> result = toppingRepository.findAll(new org.springframework.data.domain.PageRequest(firstResult / maxResults, maxResults)).getContent();
    ...
    public void testDelete() {
        ...
        toppingRepository.flush();
        Assert.assertNull("Failed to remove 'Topping' with identifier '" + id + "'", toppingRepository.findOne(id));
    }
}

...
public class PizzaIntegrationTest {
    ...
    public void testFindEntries() {
        ...
        List<Pizza> result = pizzaRepository.findAll(new org.springframework.data.domain.PageRequest(firstResult / maxResults, maxResults)).getContent();
    ...
    public void testDelete() {
        ...
        pizzaRepository.flush();
        Assert.assertNull("Failed to remove 'Pizza' with identifier '" + id + "'", pizzaRepository.findOne(id));
    }
}
